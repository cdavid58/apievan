...
class Branch(models.Model):
	...
	unit = models.BooleanField(default = True, null = True, blank = True)
	bale = models.BooleanField(default = True, null = True, blank = True)
	quantity = models.BooleanField(default = True, null = True, blank = True)
